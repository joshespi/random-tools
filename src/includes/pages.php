<?php
$PAGES = [
    'index.php'      => ['nav' => 'Home',       'title' => null,                   'description' => null],
    'picker.php'     => ['nav' => 'Picker',     'title' => 'Weighted Picker',      'description' => 'Add options, assign weights, pick. Saves named sets locally with import/export.'],
    'passphrase.php' => ['nav' => 'Passphrase', 'title' => 'Passphrase Generator', 'description' => 'Word-based passphrases with configurable count, delimiter, casing, and appended digits or symbols.'],
